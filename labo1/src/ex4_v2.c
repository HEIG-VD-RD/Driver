/**
 * @file ex4_v2.c
 * @brief This version scrolls the message on the 7-segments leds. Key0 scrolls the message to the right and Key 1 to the left. The key just needs to be pressed once.
